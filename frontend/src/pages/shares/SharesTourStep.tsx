    ...
    content: (
      <Box sx={{ p: 3, maxWidth: "600px", mx: "auto" }}>
        ...
        <Typography variant="body1" component="p">
          This section lets you view, create, edit, enable/disable and delete
          Samba shares.
        </Typography>
    ...
    content: (
      <>
        ...
        <Typography variant="body1">
          ...
          the shares section where you can manage your Samba shares.
        </Typography>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <Typography variant="body1">
          Use this button to create a new share. It's enabled when an unused
          mounted path is available.
        </Typography>
      </>
    ),
    //        action: (elem) => {
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <Typography variant="body1">
          Each share provides quick actions like settings, view mount settings,
