...
describe("DiskHealthMetrics", () => {
        ...
        const diskHealth: DiskHealth = {
            ...
            per_disk_info: {
                "Test Disk": {
                    ...
                    hdidle_status: {
                        spun_down: true,
                        last_io_at: "2025-12-15T09:00:00Z",
                        spin_down_at: "2025-12-15T10:00:00Z",
                        spin_up_at: "2025-12-15T11:00:00Z",
                    },
                },
            },
            per_disk_io: [
        ...
        const diskHealth: DiskHealth = {
            ...
            per_disk_info: {
                "Active Disk": {
                    ...
                    hdidle_status: {
                        spun_down: false,
                        last_io_at: "2025-12-15T10:00:00Z",
                        spin_down_at: "2025-12-15T09:00:00Z",
    ...
    it("shows SMART icon when SMART is supported", async () => {
        ...
        expect(within(deviceCell as HTMLElement).getByTestId("disk-health-smart-icon")).toBeTruthy();
    ...
    it("hides SMART icon when SMART is not supported", async () => {
        ...
        expect(within(deviceCell as HTMLElement).queryByTestId("disk-health-smart-icon")).toBeNull();
