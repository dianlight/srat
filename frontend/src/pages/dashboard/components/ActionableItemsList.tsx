...
export function ActionableItemsList({
  ...
  const visibleItems = itemsWithIds.filter(
    ({ id }) => showIgnored || !isIssueIgnored(id),
  );
  ...
  if (visibleItems.length === 0) {
    ...
    return (
      <Typography>
        No {showIgnored ? "" : "visible "}actionable items at the moment.
      </Typography>
    );
  }
              ...
              secondaryAction={
                <ButtonGroup size="small">
                  ...
                  <Button
                    ...
                    disabled={disabled}
                    onClick={() =>
                      isIgnored ? unignoreIssue(id) : ignoreIssue(id)
                    }
                    startIcon={
                      isIgnored ? <VisibilityIcon /> : <VisibilityOffIcon />
                    }
                  >
                    {isIgnored ? "Show" : "Hide"}
                  </Button>
