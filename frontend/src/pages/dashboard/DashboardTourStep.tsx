    ...
    content: (
      <>
        ...
        <Typography variant="body1">
          This is the tab menu, your primary navigation tool. Use it to get to
          the dashboard where you can monitor your most important metrics at a
          glance.
        </Typography>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <Typography variant="body1">
          This is the welcome and news section. Here you can find the latest
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <Typography variant="body1">
          This is the actionable items section. Here you can find tasks and
          suggestions based on your hardware and software configurations.
        </Typography>
      </>
    ),
    action: (elem) => {
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <Typography variant="body1">
          This is the metrics overview section. Here you can see key performance
          indicators and other important data at a glance.
        </Typography>
      </>
    ),
    action: (elem) => {
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <Typography variant="body1">
          Monitoring these processes helps ensure your network shares and
          discovery features are working correctly.
        </Typography>
      </>
    ),
    action: (elem) => {
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <Typography variant="body1">
          Keeping an eye on these metrics helps you detect network bottlenecks
          and maintain reliable connectivity for all your devices.
        </Typography>
      </>
    ),
    action: (elem) => {
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <Typography variant="body1">
          Here you can view the status of the Samba services running on your
          system. Monitoring these services helps ensure that file sharing and
          network access are functioning correctly.
        </Typography>
      </>
    ),
    action: (elem) => {
