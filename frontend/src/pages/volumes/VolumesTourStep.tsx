    ...
    content: (
      <Box sx={{ p: 3, maxWidth: "600px", mx: "auto" }}>
        ...
        <Typography variant="body1" component="p">
          This section lets you view, mount, unmount, and manage your storage
          volumes.
        </Typography>
    ...
    content: (
      <>
        ...
        <Typography variant="body1">
          ...
          the volumes section where you can manage your storage.
        </Typography>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <Typography variant="body1">
          Use this switch to hide system partitions and focus on the volumes
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <Typography variant="body1">
          Disks are presented in this accordion view. Click on a disk to expand
          it and see its partitions.
        </Typography>
      </>
    ),
    action: (elem) => {
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <Typography variant="body1">
          Each partition provides quick actions like mount, unmount, view
          settings, and create a share.
        </Typography>
      </>
    ),
    action: (elem) => {
