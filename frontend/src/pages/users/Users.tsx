...
export function Users() {
  ...
  const handleUserSelect = useCallback((userKey: string, user: User) => {
  ...
  useEffect(() => {
    const handleUsersStep3 = () => {
      const targetUser = getTourTargetUser(
        Array.isArray(users.data) ? users.data : undefined,
      );
    ...
    const disposeUsersStep3 = TourEvents.on(
      TourEventTypes.USERS_STEP_3,
      handleUsersStep3,
    );
            ...
            >
              ...
              {!isReadOnly && (
                <Tooltip
                  ...
                  data-tutor={`reactour__tab${TabIDs.USERS}__step2`}
                >
                  <IconButton
                    id="create_new_user"
                    color="primary"
