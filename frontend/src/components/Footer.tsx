                    ...
                    {isSmallScreen || (
                        ...
                        >
                            ...
                            <Typography variant="caption">
                                ...
                                nmbd {props.healthData.samba_process_status?.nmbd?.pid || "off"} |
                                wsdd2 {props.healthData.samba_process_status?.wsdd2?.pid || "off"} |
                                avahi {props.healthData.samba_process_status?.avahi?.pid || "off"}
                            </Typography>
                        </Tooltip>
                    )}
                    {/*
