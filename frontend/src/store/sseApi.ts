            ...
            async onCacheEntryAdded(
                ...
                try {
                    ...
                    const listener = (event: MessageEvent) => {
                        ...
                        const eventTypeEnum = Object.entries(Supported_events)
                            .find(
                        ...
                        if (eventTypeEnum) {
                            ...
                            console.error("* Unsupported WebSocket event type:", id, eventType, data);
                        }
...
// Export the hook
export const { useGetServerEventsQuery } = (process.env.SERVER_EVENT_BACKEND === "SSE" ? sseApi : wsApi);
