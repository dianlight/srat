...
docs-toc:
	...
	@find . -name "*.md" -not -path "./node_modules/*" -not -path "./frontend/node_modules/*" -not -path "./backend/src/vendor/*" -not -path "./.vale/*" -not -path "./.github/*"  | xargs bunx doctoc --github
...
docs-fix:
	...
	bunx markdownlint-cli2 "**/*.md" "#frontend/node_modules" "#backend/src/vendor" "#.vale" "#.github" --fix
