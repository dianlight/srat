...
dev_remote:
	...
	sshfs -o reconnect,ServerAliveInterval=15,ServerAliveCountMax=3 $(HOMEASSISTANT_SSH_USER)@$(HOMEASSISTANT_IP):/homeassistant/custom_components /mnt/remote_comp && \
