...
def generate_client():
    ...
    openapi_spec = Path(__file__).parent.parent / "docs" / "openapi.yaml"
    ...
    # Output directory
    output_dir = Path(__file__).parent.parent / "custom_components" / "srat_companion" / "client"
    ...
    cmd = [
        ...
        "--output-path", str(output_dir.parent),
        "--client-name", "srat_client",
        "--package-name", "client",
        "--overwrite"
    ]
