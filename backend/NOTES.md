...
This document contains development notes, useful packages, and technical references for the SRAT back-end development.
...
- **API documentation** should be autogenerated and placed in `backend/docs/`
