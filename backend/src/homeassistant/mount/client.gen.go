...
// Valid indicates whether the value is a known member of the MountUsage enum.
func (e MountUsage) Valid() bool {
	switch e {
	case Backup:
		return true
	case Media:
...
func NewRemoveMountRequest(server string, mountName string) (*http.Request, error) {
	...
	pathParam0, err = runtime.StyleParamWithOptions("simple", false, "mount_name", mountName, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "string", Format: ""})
	if err != nil {
		return nil, err
	}
