...
// Valid indicates whether the value is a known member of the SystemInfoFeatures enum.
func (e SystemInfoFeatures) Valid() bool {
	switch e {
	case Disk:
		return true
	case Haos:
...
type SystemInfo struct {
	...
	Doker           *string                `json:"doker,omitempty"`
	Features        *[]*SystemInfoFeatures `json:"features,omitempty"`
	Hassos          *string                `json:"hassos,omitempty"`
