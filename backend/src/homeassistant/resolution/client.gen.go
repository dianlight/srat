...
// Valid indicates whether the value is a known member of the IssueContext enum.
func (e IssueContext) Valid() bool {
	switch e {
	case IssueContextAddon:
		return true
	case IssueContextCore:
		return true
	case IssueContextSupervisor:
		return true
	case IssueContextSystem:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the SuggestionContext enum.
func (e SuggestionContext) Valid() bool {
	switch e {
	case SuggestionContextAddon:
		return true
	case SuggestionContextCore:
		return true
	case SuggestionContextSupervisor:
		return true
	case SuggestionContextSystem:
		return true
	default:
		return false
	}
