...
func (i *IssueSeverity) UnmarshalJSON(b []byte) error {
	b = bytes.Trim(bytes.Trim(b, "\""), "\"")
	newi, err := ParseIssueSeverity(b)
	if err != nil {
		return err
	}
	*i = newi
...
func (i *IssueSeverity) UnmarshalText(b []byte) error {
	newi, err := ParseIssueSeverity(b)
	if err != nil {
		return err
	}
...
// It returns an error if the byte slice does not contain a valid enum value.
func (i *IssueSeverity) UnmarshalBinary(b []byte) error {
	newi, err := ParseIssueSeverity(b)
	if err != nil {
		return err
	}
...
func (i *IssueSeverity) UnmarshalYAML(b []byte) error {
	newi, err := ParseIssueSeverity(b)
	if err != nil {
		return err
	}
