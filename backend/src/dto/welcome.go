...
type Welcome struct {
	...
	SupportedEvents []WebEventType `json:"supported_events" enum:"hello,updating,volumes,heartbeat,shares,dirty_data_tracker,smart_test_status,filesystem_task,error,repair_command"`
