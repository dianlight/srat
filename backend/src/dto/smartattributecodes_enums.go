...
func (s *SmartAttributeCode) UnmarshalJSON(b []byte) error {
	b = bytes.Trim(bytes.Trim(b, "\""), "\"")
	news, err := ParseSmartAttributeCode(b)
	if err != nil {
		return err
	}
	*s = news
...
func (s *SmartAttributeCode) UnmarshalText(b []byte) error {
	news, err := ParseSmartAttributeCode(b)
	if err != nil {
		return err
	}
...
// It returns an error if the byte slice does not contain a valid enum value.
func (s *SmartAttributeCode) UnmarshalBinary(b []byte) error {
	news, err := ParseSmartAttributeCode(b)
	if err != nil {
		return err
	}
...
func (s *SmartAttributeCode) UnmarshalYAML(b []byte) error {
	news, err := ParseSmartAttributeCode(b)
	if err != nil {
		return err
	}
