...
// It is private; use the exported WebEventType values and methods instead.
...
var WebEventTypes = webEventTypesContainer{
	...
	EVENTFILESYSTEMTASK: WebEventType{
		webEventType: eventFilesystemTask,
	},
	EVENTERROR: WebEventType{
...
// Otherwise, it returns nil
func numberToWebEventType[T interface {
	...
	switch f {
	case 0:
		result := WebEventTypes.EVENTHELLO
		if !result.IsValid() {
			return nil
		}
		return &result
	case 1:
		result := WebEventTypes.EVENTUPDATING
		if !result.IsValid() {
			return nil
		}
		return &result
	case 2:
		result := WebEventTypes.EVENTVOLUMES
		if !result.IsValid() {
			return nil
		}
		return &result
	case 3:
		result := WebEventTypes.EVENTHEARTBEAT
		if !result.IsValid() {
			return nil
		}
		return &result
	case 4:
		result := WebEventTypes.EVENTSHARES
		if !result.IsValid() {
			return nil
		}
		return &result
	case 5:
		result := WebEventTypes.EVENTDIRTYTRACKER
		if !result.IsValid() {
			return nil
		}
		return &result
	case 6:
		result := WebEventTypes.EVENTSMARTTESTSTATUS
		if !result.IsValid() {
			return nil
		}
		return &result
	case 7:
		result := WebEventTypes.EVENTFILESYSTEMTASK
		if !result.IsValid() {
			return nil
		}
		return &result
	case 8:
		result := WebEventTypes.EVENTERROR
		if !result.IsValid() {
			return nil
		}
		return &result
	case 9:
		result := WebEventTypes.EVENTREPAIRCOMMAND
		if !result.IsValid() {
			return nil
		}
		return &result
	case 10:
		result := WebEventTypes.EVENTPROBLEM
		if !result.IsValid() {
			return nil
		}
		return &result
	case 11:
		result := WebEventTypes.EVENTAPPCONFIGCHANGED
		if !result.IsValid() {
			return nil
		}
		return &result
	case 12:
		result := WebEventTypes.EVENTMDNSREGISTER
		if !result.IsValid() {
			return nil
		}
		return &result
	case 13:
		result := WebEventTypes.EVENTCOMMANDSTARTED
		if !result.IsValid() {
			return nil
		}
		return &result
	case 14:
		result := WebEventTypes.EVENTCOMMANDOUTPUT
		if !result.IsValid() {
			return nil
		}
		return &result
	case 15:
		result := WebEventTypes.EVENTCOMMANDTERMINATED
		if !result.IsValid() {
			return nil
		}
		return &result
