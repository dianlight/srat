...
- [Test Remote Environment](#test-remote-environment)
  - [When to Use](#when-to-use)
  - [Prerequisites](#prerequisites)
  - [Argument Handling (Custom Component Scope)](#argument-handling-custom-component-scope)
  - [Procedure](#procedure)
    - [Step 1 — Build and deploy the backend](#step-1--build-and-deploy-the-backend)
    - [Step 2 — Restart the addon to pick up the new binary](#step-2--restart-the-addon-to-pick-up-the-new-binary)
    - [Step 3 — Verify runtime health via logs (core first, then addon)](#step-3--verify-runtime-health-via-logs-core-first-then-addon)
    - [Step 4 — (Optional) Deploy custom component when requested](#step-4--optional-deploy-custom-component-when-requested)
    - [Step 5 — (Optional) Start the frontend dev server](#step-5--optional-start-the-frontend-dev-server)
    - [Step 6 — Browse and validate the UI with Playwright](#step-6--browse-and-validate-the-ui-with-playwright)
    - [Step 7 — Read logs again after UI interaction (core first, then addon)](#step-7--read-logs-again-after-ui-interaction-core-first-then-addon)
    - [Step 8 — Clean up](#step-8--clean-up)
  - [Decision Tree](#decision-tree)
  - [Troubleshooting Reference](#troubleshooting-reference)
  - [Increase Custom Component Verbosity](#increase-custom-component-verbosity)
  - [Addon Info Reference](#addon-info-reference)
