...
- Progress update (2026-03-15):
    ...
    - Remote validation against the Home Assistant test environment (`local_sambanas2`, build `2026.3.0-dev.4`) succeeded: the addon restarted cleanly, the frontend loaded via `mise run //frontend:dev:remote`, and the Dashboard, Volumes, and Shares tabs rendered without visible UI regressions.
