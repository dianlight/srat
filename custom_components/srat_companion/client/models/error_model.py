...
class ErrorModel:
    ...
    errors: None | Unset | list["ErrorDetail"] = UNSET
    instance: Unset | str = UNSET
    status: Unset | int = UNSET
    title: Unset | str = UNSET
    type_: Unset | str = "about:blank"
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        errors: None | Unset | list[dict[str, Any]]
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        def _parse_errors(data: object) -> None | Unset | list["ErrorDetail"]:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast("None | Unset | list[ErrorDetail]", data)
