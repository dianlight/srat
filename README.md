...
[![Backend Unit Test Coverage](https://img.shields.io/badge/Backend_Unit_Tests-34.3%25-orange?logo=go)](docs/TEST_COVERAGE.md "Backend Go unit test coverage")
[![Frontend Unit Test Coverage](https://img.shields.io/badge/Frontend_Unit_Tests-70.30%25-green?logo=typescript)](docs/TEST_COVERAGE.md "Frontend TypeScript unit test coverage")
[![Global Unit Test Coverage](https://img.shields.io/badge/Global_Unit_Tests-48.7%25-yellow)](docs/TEST_COVERAGE.md "Overall unit test coverage (weighted average)")
